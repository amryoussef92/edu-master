...
export default function AdminLayout() {
  ...
  const navigation = [
    { name: "Home", href: "/admin/home", icon: <FaHome />, gradient: "from-blue-500 to-purple-600" },
    { name: "Users", href: "/admin/users", icon: <FaUsers />, gradient: "from-green-500 to-teal-600" },
    { name: "Profile", href: "/admin/profile", icon: <FaUser />, gradient: "from-orange-500 to-red-600" },
    { name: "Lessons", href: "/admin/lessons", icon: <FaBook />, gradient: "from-indigo-500 to-blue-600" },
  ];
